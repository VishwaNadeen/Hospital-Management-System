...
<main>
    <section class="hero">
        <div class="hero-content">
            ...
            <div class="cta-buttons">
                <button class="btn btn-primary" onclick="location.href='pages/patient/Appointment.jsp';" >Book Appointment</button>
    ...
    <section class="quick-access">
        <div class="access-card" onclick="location.href='pages/patient/Appointment.jsp';" style="cursor: pointer;">
