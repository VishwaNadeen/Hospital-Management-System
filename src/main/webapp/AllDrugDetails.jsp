...
<table border="1">
    ...
    <tr>
        ...
        <td>
        	<a href="pharmacistAllUpdate.jsp?item_id=${phas.item_id}&item_name=${phas.item_name}&item_type=${phas.item_type}&quantity_in_stock=${phas.quantity_in_stock}&unit_price=${phas.unit_price}&
