    ...
    <main class="admin-layout">
        <aside class="admin-sidebar">
            ...
            <nav class="sidebar-nav" aria-label="Admin navigation">
                <a class="nav-item active js-workspace-link" href="AdminDoctorPanel.jsp" target="adminWorkspaceFrame" data-title="Doctor Portal" data-match="AdminDoctorPanel.jsp,AdminDoctorAdd.jsp,doctorInsert.jsp,AllDoctorsDisplay.jsp">
                    <i class="fa-solid fa-user-doctor"></i>
                    <span>Doctor Portal</span>
                </a>
                <a class="nav-item js-workspace-link" href="AdminPharmacistPanel.jsp" target="adminWorkspaceFrame" data-title="Pharmacist Portal" data-match="AdminPharmacistPanel.jsp,PharmacistHome.jsp,PharmacistSearch.jsp,pharmacistInsert.jsp,PharmacistDetails.jsp,pharmacistAllUpdate.jsp,AllDrugDetails.jsp">
                    <i class="fa-solid fa-capsules"></i>
                    <span>Pharmacist Portal</span>
                </a>
                <a class="nav-item js-workspace-link" href="AdminMedicalRecordPanel.jsp" target="adminWorkspaceFrame" data-title="Medical Records" data-match="AdminMedicalRecordPanel.jsp,SearchRecord.jsp,RecordDisplay.jsp,EnterRecord.jsp,UpdateRecord.jsp,DeleteRecord.jsp">
            ...
            <div class="sidebar-footer">
                <a class="logout-btn" href="Home.jsp">
    ...
    <script>
        ...
        (function () {
            ...
            function setActiveByPage(pageName) {
                let hasMatch = false;
                links.forEach((item) => {
                    const matchList = (item.dataset.match || '').split(',').map((v) => v.trim());
