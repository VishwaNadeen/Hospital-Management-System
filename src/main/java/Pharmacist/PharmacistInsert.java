...
public class PharmacistInsert extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (!expDate.isAfter(today)) {
			...
			request.getRequestDispatcher("pharmacistInsert.jsp").forward(request, response);
			return;
		}
		...
		jakarta.servlet.RequestDispatcher dis = request.getRequestDispatcher("pharmacistInsert.jsp");
