...
@WebServlet("/AllDoctorsUpdateServlet")
public class AllDoctorsUpdateServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		isTrue = DoctorDBUtil.allUpdatedata(first_name, last_name, id_no, user_name, password, dob, gender, phone, email, address, 
